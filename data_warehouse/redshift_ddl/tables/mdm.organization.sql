CREATE TABLE IF NOT EXISTS mdm.organization
(
	...
	,parent_org_id VARCHAR(36)   ENCODE zstd
	,org_id INTEGER   ENCODE zstd
...
GRANT ALL on mdm.organization to group dw_dev_users;
GRANT ALL on mdm.organization to group devgroup;
GRANT ALL on mdm.organization to group dev_redshiftcoredevgroup;
GRANT ALL on mdm.organization to group dev_redshiftcoreadmingroup;
GRANT SELECT on mdm.organization to group dev_redshiftcorereadngroup;
GRANT SELECT on mdm.organization to group dev_redshiftcorereadgroup;
